...
const s = {
  ...
  /** @param {boolean} online */
  onlineLabel: (online) => ({ fontSize: "12px", color: online ? "#23a55a" : "#5c6068" }),
  closeBtn: {
 ...
 * />
 */
export default function UserProfileModal({ userId, isOnline = false, onClose, onStartDm }) {
  ...
  useEffect(() => {
    if (!userId) return;
    setLoading(true);
    authFetch(`${API}/auth/users/${userId}`)
  ...
  async function handleSaveRole() {
    ...
    try {
      ...
      setRoleMsg({ type: "err", text: e.message || "Failed to update role" });
    } finally {
      setSaving(false);
    }
  }
            ...
            <div style={s.header}>
              ...
              <div style={s.headerInfo}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "6px", marginTop: "4px" }}>
                  ...
                  <span style={s.roleBadge(profile.role)}>

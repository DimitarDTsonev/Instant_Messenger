            ...
            <>
              {myRole === "owner" && (
                <select
                  ...
                  onChange={(e: ChangeEvent<HTMLSelectElement>) => handleRole(m.id, e.target.value as Exclude<ChannelRole, "owner">)}
                >
 ...
 * @returns {JSX.Element}
 */
function PermissionsTab({ channelId, myRole }: { channelId: number; myRole: ChannelRole | string }) {
 ...
 * @returns {JSX.Element}
 */
function InvitesTab({ channelId }: { channelId: number }) {
...
export default function ChannelSettingsModal({
   ...
   */
  function handleUpdated(updated: Channel) {

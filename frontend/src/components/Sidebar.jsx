// ============================================================
//  components/Sidebar.jsx — Left panel with channels and users
// ============================================================
...
export default function Sidebar({
   ...
   * @returns {boolean}
   */
  const isChannelOwnerOrAdmin = (ch) =>
                  ...
                  <div style={{ display: "flex", gap: "2px" }}>
                    ...
                    {canDel && (
                      <button
                        ...
                        onClick={(e) => { e.stopPropagation(); onDeleteChannel?.(ch); }}
                      >
                        🗑️
                      </button>
                    )}

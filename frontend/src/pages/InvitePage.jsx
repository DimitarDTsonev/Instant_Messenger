// ============================================================
//  pages/InvitePage.jsx — Channel invite landing page
 ...
 *
 * After a successful join in all cases, the user is redirected to "/" via
 * window.location.replace so the App re-renders with the new session.
 *
 * @component
 * @param {Object} props
 * @param {string} props.code - The invite code extracted from the URL path by App.jsx.
 * @returns {JSX.Element}
 */
    ...
    return (
      <div style={s.page}>
        <div style={s.card}>
          ...
          <button style={s.btn("secondary")} onClick={() => window.location.replace("/")}>
            Back to home
          </button>
        </div>
      </div>

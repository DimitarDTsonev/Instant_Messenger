 ...
 */
function saveSession(channelId, dmUserId) {
...
export default function ChatPage() {
   ...
   */
  async function handleCreateChannel(name, description, is_private) {
   ...
   */
  function handleChannelUpdated(updated) {
   ...
   */
  function handlePin(messageId, isCurrentlyPinned) {
    if (isCurrentlyPinned) {
      unpinMessage(messageId, ({ error } = {}) => { if (error) console.error("Unpin error:", error); });
    } else {
      pinMessage(messageId, ({ error } = {}) => { if (error) console.error("Pin error:", error); });
    }
  }
   ...
   */
  function handleUnpinFromBanner(messageId) {
    unpinMessage(messageId, ({ error } = {}) => { if (error) console.error("Unpin error:", error); });
  }

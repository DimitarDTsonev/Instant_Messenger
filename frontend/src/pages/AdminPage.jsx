// ============================================================
//  pages/AdminPage.jsx — Admin dashboard (user list + security logs)
// ============================================================
...
export default function AdminPage() {
  ...
  const [banModal, setBanModal] = useState(null); // { user } | null
  ...
  return (
    <div style={s.page}>
      {/* Header */}
      <div style={s.header}>
        <button style={s.backBtn} onClick={() => { window.history.pushState({}, "", "/"); window.location.reload(); }} data-testid="back-btn">
          Back
        </button>

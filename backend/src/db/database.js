// ============================================================
//  src/db/database.js — SQLite database initialisation
//
...
// Absolute path to the SQLite file stored at the backend project root
...
function initDatabase() {
  ...
  const existingChannels = db.prepare("SELECT id, created_by FROM channels WHERE created_by IS NOT NULL").all();
